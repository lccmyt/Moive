 ...
 */
public class LoadingMovieFragment extends BaseFragment implements MovieContract.IView {
    @BindView(R.id.rv)
    RecyclerView rv;
    ...
    protected void initView(View v) {
        ...
        moreLoadingMovieAdapter = new MoreLoadingMovieAdapter(getContext());
        rv.setAdapter(moreLoadingMovieAdapter);
    ...
    protected void initData() {
        ...
        if (presenter instanceof MoviePresenter) {
            ((MoviePresenter) presenter).showLoadingMovie(1, 30);
        }
    }

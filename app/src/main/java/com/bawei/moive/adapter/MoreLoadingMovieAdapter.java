 ...
 */
public class MoreLoadingMovieAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MoreLoadingMovieAdapter(Context context) {
        mContext = context;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        String director = mList.get(position).getDirector();
        director.replace("/n", "");
        ((ViewHolder)holder).tvDirector.setText("导演:  " +   director);

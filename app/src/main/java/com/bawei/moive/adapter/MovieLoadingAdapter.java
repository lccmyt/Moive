 ...
 */
public class MovieLoadingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private Context mContext;
    private List<LoadingMovieBean.ResultBean> mList = new ArrayList();

    public MovieLoadingAdapter(Context context) {
        mContext = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(mContext, R.layout.item_loadingmovie, null);
